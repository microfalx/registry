...
public interface Storage {
     ...
     * Changes the data in the registry at a given path.
     * <p>
     * This method validates the version to be the expected value. If not the same, it will
     * throw {@link RegistryVersionConflictException}
     *
     * @param path    the path
     * @param data    the data
     * @param version the version of the existing data
     */
